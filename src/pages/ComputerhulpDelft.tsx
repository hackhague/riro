...
export default function ComputerhulpDelft() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 md:py-16 bg-secondary">
        <div className="container mx-auto px-4">
          <h2 className="font-heading font-bold text-3xl text-center mb-8">Recent in Delft opgelost</h2>
          <Card className="max-w-2xl mx-auto">
            <CardContent className="p-6">
              <div className="mb-4">
                <span className="text-xs font-semibold text-accent uppercase">Probleem</span>
                <p className="text-foreground/80 mt-1">
                  WiFi dode zones in studentenhuis, uploads falen constant
                </p>
              </div>
              <div className="mb-4">
                <span className="text-xs font-semibold text-primary uppercase">Oplossing</span>
                <p className="text-foreground/80 mt-1">
                  Mesh netwerk geïnstalleerd + router optimalisatie
                </p>
              </div>
              <div>
                <span className="text-xs font-semibold text-foreground uppercase">Resultaat</span>
                <p className="font-semibold mt-1">"Volle snelheid op alle kamers, eindelijk stabiel"</p>
              </div>
              <p className="text-sm text-foreground/60 mt-4">TU-buurt, Delft</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Wat kost computerhulp in Delft?</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Hoe snel zijn jullie ter plaatse in Delft?</h3>
                <p className="text-foreground/70">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Helpen jullie ook studenten aan de TU?</h3>
                <p className="text-foreground/70">
                  Ja, we helpen iedereen – particulieren, studenten, bedrijven. Zelfde vaste prijzen.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-12 md:py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-heading font-bold text-3xl mb-6">Hulp nodig in Delft?</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="whatsapp" size="lg" asChild>
              <a
                href="https://wa.me/31702119191?text=Hallo%2C%20ik%20ben%20in%20Delft%20–%20kunnen%20jullie%20helpen%3F"
