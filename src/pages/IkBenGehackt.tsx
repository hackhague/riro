{/* --- Tarieven: twee blokken (Particulier | Zakelijk) — fallback zonder Card-componenten --- */}
    ...
    <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {/* Kaart - Eerste hulp op afstand */}
          <div className="rounded-lg border-2 border-accent bg-white">
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {/* Kaart - Eerste hulp op afstand zakelijk */}
          <div className="rounded-lg border-2 border-accent bg-white">
            <div className="p-6 text-center">
              <Zap className="h-8 w-8 text-accent mx-auto mb-3" />
          ...
          {/* Kaart - First Response pakket (brede col) */}
          <div className="rounded-lg border-2 border-primary bg-white col-span-full sm:col-span-2">
            <div className="p-6 text-center">
              <Shield className="h-8 w-8 text-primary mx-auto mb-3" />
