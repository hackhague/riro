...
import { MessageCircle, Phone, AlertTriangle, CheckCircle, Calendar } from "lucide-react";
      ...
      <section className="relative flex items-center overflow-hidden min-h-[400px] md:min-h-[500px]">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="InstantIT WhatsApp fraude hulp"
            fill
            priority
            placeholder="blur"
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button variant="outline" size="lg" asChild>
                <a href="https://wa.me/31853696124?text=WhatsApp%20fraude%20hulp" target="_blank" rel="noopener noreferrer">
