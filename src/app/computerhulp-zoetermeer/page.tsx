...
export const metadata: Metadata = {
  title: "Computerhulp in Zoetermeer",
  description:
    "InstantIT helpt Zoetermeer met snelle computerhulp, wifi en cybersecurity. Remote binnen 30 minuten, on-site meestal binnen 2 uur.",
  alternates: {
    canonical: "https://www.instantit.nl/computerhulp-zoetermeer",
  },
};

export default function ComputerhulpZoetermeer() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-foreground mb-6">
              Computerhulp in Zoetermeer – binnen 2 uur geholpen
            </h1>
            <p className="text-lg md:text-xl text-foreground/80 mb-8">
              InstantIT helpt particulieren en bedrijven in heel Zoetermeer – van Meerzicht tot Rokkeveen en Buytenwegh. 
          ...
          <Card className="max-w-4xl mx-auto border-2 border-primary/20">
            <CardContent className="p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="font-heading font-bold text-2xl mb-3">Lokaal & Snel in Zoetermeer</h2>
                  <p className="text-foreground/80 mb-4">
                    Of je nu in Meerzicht, Rokkeveen of Buytenwegh woont – wij zijn er snel. 
      ...
      <section className="py-12 md:py-16 bg-secondary">
        <div className="container mx-auto px-4">
          <h2 className="font-heading font-bold text-3xl text-center mb-8">Recent in Zoetermeer opgelost</h2>
          <Card className="max-w-2xl mx-auto">
            <CardContent className="p-6">
              <div className="mb-4">
                <span className="text-xs font-semibold text-accent uppercase">Probleem</span>
                <p className="text-foreground/80 mt-1">
                  Laptop extreem traag, constant updates die vastlopen
                </p>
              </div>
              <div className="mb-4">
                <span className="text-xs font-semibold text-primary uppercase">Oplossing</span>
                <p className="text-foreground/80 mt-1">
                  Opschoning, SSD upgrade, clean Windows installatie
                </p>
              </div>
              <div>
                <span className="text-xs font-semibold text-foreground uppercase">Resultaat</span>
                <p className="font-semibold mt-1">"Als een nieuwe laptop, alles werkt weer perfect"</p>
              </div>
              <p className="text-sm text-foreground/60 mt-4">Rokkeveen, Zoetermeer</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Wat kost computerhulp in Zoetermeer?</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Hoe snel zijn jullie ter plaatse in Zoetermeer?</h3>
                <p className="text-foreground/70">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-2">Werken jullie ook in het weekend?</h3>
                <p className="text-foreground/70">
                  Ja, we zijn 7 dagen per week beschikbaar. Voor spoedhulp bij hacks zelfs 24/7.
                </p>
              </CardContent>
            </Card>
          </div>
